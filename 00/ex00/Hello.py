...
def main():
    """Learning differences from data structures : list, tuple, set and dictionnaires"""
    ft_list = ["Hello", "tata!"]
    ft_tuple = ("Hello", "toto!")
    ft_set = {"Hello", "tutu!"}
    ft_dict = {"Hello" : "titi!"}
    ...
    # Upon printing they might appear in different order because of the nature of set
    ft_set.remove("tutu!")
    ft_set.add("Paris")
